...
#pragma warning (disable: 26495)
	...
	{
		rgba32::api::rgba32_to_rgba8(&rgba.r, &this->value);
	}
	rgba8::rgba8(hsva hsva)
	{
		float output[4];
		rgba32::api::hsva_to_rgba32(&hsva.h, output);
		rgba32::api::rgba32_to_rgba8(output, &value);
	}
	rgba8::rgba8(hsla hsla)
	{
		float output[4];
		rgba32::api::hsla_to_rgba32(&hsla.h, output);
		rgba32::api::rgba32_to_rgba8(output, &value);
	}			
	rgba8::rgba8(cmyk cmyk)
	{
		float output[4];
		rgba32::api::cmyk_to_rgba32(&cmyk.c, output);
		rgba32::api::rgba32_to_rgba8(output, &value);
	}
	void rgba8::api::rgba8_to_abgr8(const u32 input, u32* output)
	{
		*output =
			((input >> 24) & 0x000000FF) |
			((input >> 8)  & 0x0000FF00) |
	...
	void rgba8::api::abgr8_to_rgba8(const u32 input, u32* output)
	{
		*output =
			((input >> 24) & 0x000000FF) |
			((input >> 16) & 0x0000FF00) |
	...
	void rgba8::api::rgba8_to_rgba32(const u32 input, f32* output)
	{
	...
	{
		rgba8::api::rgba8_to_rgba32(value, &this->r);
	}
	...
	{
		rgba8::api::rgba8_to_rgba32(rgba.value, &this->r);
	}
	rgba32::rgba32(hsva hsva)
	{
		api::hsva_to_rgba32(&hsva.h, &this->r);
	}
	rgba32::rgba32(hsla hsla)
	{
		api::hsla_to_rgba32(&hsla.h, &this->r);
	}
	rgba32::rgba32(cmyk cmyk)
	{
		api::cmyk_to_rgba32(&cmyk.c, &this->r);
	}

	void rgba32::api::rgba32_to_rgba8(const f32* input, u32* output)
	{
		*output =
	...
	void rgba32::api::rgba32_to_hsva(const f32* input, f32* output)
	{
		float cmax =
			(input[0] > input[1] ?
	...
	void rgba32::api::rgba32_to_hsla(const f32* input, f32* output)
	{
		float cmax =
			(input[0] > input[1] ?
				(input[0] > input[2] ? input[0] : input[2]) :
	...
	void rgba32::api::rgba32_to_cmyk(const f32* input, f32* output)
	{
		float max =
			(input[0] > input[1] ?
				(input[0] > input[2] ? input[0] : input[2]) :
	...
	void rgba32::api::hsva_to_rgba32(const f32* input, f32* output)
	{
	...
	void rgba32::api::hsla_to_rgba32(const f32* input, f32* output)
	{
	...
	void rgba32::api::cmyk_to_rgba32(const f32* input, f32* output)
	{
