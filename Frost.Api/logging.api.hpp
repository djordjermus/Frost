...
extern "C"
{
	...
	FROST_API void _stdcall logging_verbose(
	...
	FROST_API void _stdcall logging_debug(
		const wchar_t* message_template,
		u64 template_length,
		const wchar_t** params,
		const u64* param_lengths,
	...
	FROST_API void _stdcall logging_info(
		const wchar_t* message_template,
		u64 template_length,
		const wchar_t** params,
		const u64* param_lengths,
	...
	FROST_API void _stdcall logging_warning(
		const wchar_t* message_template,
		u64 template_length,
		const wchar_t** params,
		const u64* param_lengths,
	...
	FROST_API void _stdcall logging_error(
		const wchar_t* message_template,
		u64 template_length,
		const wchar_t** params,
		const u64* param_lengths,
	...
	FROST_API void _stdcall logging_critical(
		const wchar_t* message_template,
		u64 template_length,
		const wchar_t** params,
		const u64* param_lengths,
