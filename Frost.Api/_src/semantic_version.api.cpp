...
bool semantic_version_check_compatibility(semantic_version version, semantic_version target)
{
	return
...
void semantic_version_get_api_version(semantic_version* output)
{
