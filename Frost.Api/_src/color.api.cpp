...
void rgba8_to_rgba32(const u32 input, f32* output)
{
...
void rgba32_to_rgba8(const f32* input, u32* output)
{
	*output =
...
void rgba32_to_hsva(const f32* input, f32* output)
{
	float cmax =
		(input[0] > input[1] ?
...
void rgba32_to_hsla(const f32* input, f32* output)
{
	float cmax =
		(input[0] > input[1] ?
			(input[0] > input[2] ? input[0] : input[2]) :
...
void rgba32_to_cmyk(const f32* input, f32* output)
{
	float max =
		(input[0] > input[1] ?
			(input[0] > input[2] ? input[0] : input[2]) :
...
void hsva_to_rgba32(const f32* input, f32* output)
{
...
void hsla_to_rgba32(const f32* input, f32* output)
{
...
void cmyk_to_rgba32(const f32* input, f32* output)
{
