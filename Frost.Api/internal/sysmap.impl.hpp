...
namespace frost::impl
{
	...
	public:
		...
		static bool keycode_to_wchar(api::keycode internal_keycode, wchar_t* output, u64 output_length);
		static bool syskey_to_wchar(u8 system_keycode, wchar_t* output, u64 output_length);
