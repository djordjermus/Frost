...
internal static partial class FrostApi
{
    ...
    public static partial class Thread
    {
		...
		[UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
		[return: MarshalAs(UnmanagedType.Bool)]
		public static partial bool SendMessage(IntPtr thread, IntPtr procedure, IntPtr argument);
		...
		[UnmanagedCallConv(CallConvs = [typeof(CallConvStdcall)])]
		[return: MarshalAs(UnmanagedType.Bool)]
		public static partial bool SendMessageAsync(IntPtr thread, IntPtr sync, IntPtr procedure, IntPtr argument);
	}
