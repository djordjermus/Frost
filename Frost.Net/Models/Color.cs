    ...
    public struct Color
    {
        ...
        internal static class Interop
        {
            ...
            [DllImport(
                ...
                EntryPoint = "?color_rgba8_to_rgba32@rgba8@frost@@SAXKPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_rgba32_to_rgba8@rgba32@frost@@SAXPEBMPEAK@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_rgba32_to_hsva@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_rgba32_to_hsla@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_rgba32_to_cmyk@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_hsva_to_rgba32@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_hsla_to_rgba32@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?color_cmyk_to_rgba32@rgba32@frost@@SAXPEBMPEAM@Z")]
