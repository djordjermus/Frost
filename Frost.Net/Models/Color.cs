    ...
    public struct Color
    {
        ...
        internal static class Interop
        {
            ...
            [DllImport(
                ...
                EntryPoint = "?rgba8_to_rgba32@api@rgba8@frost@@SAXKPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?rgba32_to_rgba8@api@rgba32@frost@@SAXPEBMPEAK@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?rgba32_to_hsva@api@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?rgba32_to_hsla@api@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?rgba32_to_cmyk@api@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?hsva_to_rgba32@api@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?hsla_to_rgba32@api@rgba32@frost@@SAXPEBMPEAM@Z")]
            ...
            [DllImport(
                dllName: Settings.frostApiPath,
                CallingConvention = CallingConvention.StdCall,
                EntryPoint = "?cmyk_to_rgba32@api@rgba32@frost@@SAXPEBMPEAM@Z")]
